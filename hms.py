...
if cursor.fetchone()[0]==0:
    ...
    cursor.execute("""insert into patient values(001,'Ravi','Nagu','Hyderabad','12-March-2002',19,'08-March-2020',9876543218)""")
    cursor.execute("""insert into patient values(002,'Mahesh','Boppam','Banglore','12-May-2001','20','05-june-2021',9875435676)""")
    cursor.execute("""insert into patient values(003,'sruthi','jani','chennai','22-Dec-2001','18','19-Nov-2020',92767854566)""")
    cursor.execute("""insert into patient values(004,'Amul','Vera','Delhi','06-Jan-2001',18,'25-Oct-2011',8765435459)""")
    cursor.execute("""insert into patient values(005,'james','pandiri','kolkata','23-Nov-2002',16,'23-Nov-2018',7689453543)""")
    cursor.execute("""insert into patient values(006,'venkatesh','varma','karimnagar','23-April-2000',15,'23-july-2016',8498423858)""")
    cursor.execute("""insert into virus values(001,'Ebola','Ebov','Oxygen Therapy, IV Fluids','Muscle Pain, Fever, Bleeding')""")
    cursor.execute("""insert into virus values(002,'Measles','Paramyxo','Vitamin A','Cough, Skin Rash')""")
    cursor.execute("""insert into bacteria values(003,'TB','Mycobacterium','Antibiotics','Cough and Sneezes')""")
    cursor.execute("""insert into bacteria values(004,'Cholera','Vibrio','IV Fluids, Antibiotics','Seizures, Diarrhoea')""")
    cursor.execute("""insert into injury values(005,'Hair line Fracture','Plaster, Pain Killer','Toe Fracture')""")
    cursor.execute("""insert into injury values(006,'bullet wound','Removal of Bullet','Wound')""")
